...
from transformers import (AutoModelForCausalLM, AutoTokenizer,
                          DataCollatorForSeq2Seq, PreTrainedTokenizerBase)
...
def main(
    ...
    print(f"Loading tokenizer {loading_model_name}...")
    tokenizer = AutoTokenizer.from_pretrained(
        pretrained_model_name_or_path=(loading_model_name),
        cache_dir=cache_dir,
    ...
    print(f"Loading model {loading_model_name}...")
    model = AutoModelForCausalLM.from_pretrained(
        pretrained_model_name_or_path=loading_model_name,
        cache_dir=cache_dir,
        trust_remote_code=True if "falcon" in model_name else False,
    )
