...
class LRP2mGPTForCausalLM(GPT2LMHeadModel):
    def __init__(self, config):
        super().__init__(config)
        self.transformer = LRP2mGPTModel(config)
...
if __name__ == "__main__":
    ...
    model = LRP2mGPTForCausalLM.from_pretrained("ai-forever/mGPT")
    tokenizer = AutoTokenizer.from_pretrained("ai-forever/mGPT")

    en_vector = np.load(
        "/home/hwichan/prune_for_multilingual/outputs/ai-forever/mGPT/lang_vector/en_vector.npy"
    )
    zh_vector = np.load(
        "/home/hwichan/prune_for_multilingual/outputs/ai-forever/mGPT/lang_vector/zh_vector.npy"
    )
